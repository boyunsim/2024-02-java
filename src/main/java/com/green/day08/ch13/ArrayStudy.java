...
public class ArrayStudy {
    /*
        ...
        예를 들어, int n1, n2, n3... ,n100; 까지

        그치만 배열을 사용하여 여러 데이터를 편하게 저장하고 가져올 수 있다.
        (read/ write)
        ...
        다른 타입 배열의 주소값은 저장할 수 없다.

        new int[]; int형의 공간이 100개가 만들어졌다.
        각 공간은 int값만 저장할 수 있다.

        new String[]; String형의 공간이 100개가 만들어졌다.
