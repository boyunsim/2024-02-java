...
public class PolyStudy {
    /*
        ...
        3. 타입은 호출할 수 있냐없냐(아는 메소드만 호출 가능, 모르는 메소드는 호출불가)를 구분하고,
    ...
    public static void main(String[] args) {
        ...
        //BullDog bullDog1 = (BullDog)ani2;
        //ani2에는 Dog객체 주소값이 저장되어 있음.
        // 자식타입인 BullDog에 부모객체인 Dog객체 주소값을 담으려고 하니
        // 런타임 에러 발생

        //불독은 jump 메소드를 알고있는데 Dog 는 jump 메소드 안 가지고 있기 때문에
        ...
        */
        ...
        //3번 검증
        //ani3.jump(); //ani3에는 BullDog객체 주소값이 저장되어 있느나
