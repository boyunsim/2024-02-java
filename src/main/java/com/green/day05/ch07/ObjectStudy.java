...
public class ObjectStudy {
    /*
        ...
        ✔👀✔속성(멤버 필드)은 데이터를 저장하기 위한 공간(전역 변수)
        인간 - 속성(멤버 필드, 전역 변수): 혈액형, 생년월일, 성별, 국가, 머리 색, 키, 몸무게

            - 메소드: 일어난다, 소리 지른다, 잔다, 뛴다

        클래스를 이용해서 객체(인스턴스)를 만든다.
        만드는 행위 >> 객체화 || 인스턴스화 라고 부르며
        new 키워드를 사용한다.
        ...
        작동하는 방식을 적는 것이다.
        예를들어, 이러이러한 데이터를 저장해라, 이러이러한 데이터를 변경해라.
        ...
        예를들어:
        Karl(클래스명) abc(변수명);
        abc는 Karl객체의 주소값만 담을 수 있다. (저장할 수 있다.)
